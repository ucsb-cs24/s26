...
assigned: 2026-05-04 09:00:00.00-08:00
...
Please read the entire writeup before beginning the assignment. In particular, take a look at part 3a to understand your requirements for a full score before attempting to implement a solution. You are graded on the running time efficiency of your solution. 
...
Obtain the starter code from this repo: <https://github.com/ucsb-cs24-w26/STARTER-pa02>
...
## Optional Part 3: Analyze the time and space complexity of your algorithm from part 2
...
* Be sure to check that the trend in your proposed time complexity somewhat matches with the trends in your measured runtimes.
...
* We **DO NOT** allow multi-threading in this assignment although you are welcome to explore that on your own. But the leaderboard will be based on the most optimized solution that runs as a single thread. 
* Optionally, include your space and time complexity analyses (part 3) in `main.cpp`, as a commented block under the `main()` function. This part will not be graded but you can use it to discuss your approach with the course staff in office hours
