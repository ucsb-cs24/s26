...
assigned: 2026-05-20 09:00:00.00-08:00
...
Refer to lab01 for instructions on how to set up a GitHub repository and pull the starter code for this lab. Here is the link for this lab’s starter code: <https://github.com/ucsb-cs24-s26/STARTER-pa03>
...
**Video 2 (20 min)** — Gradient descent, how neural networks learn:
[3Blue1Brown: Gradient descent, how neural networks learn](https://youtu.be/IHZwWFHWa-w?si=_e4wkFW624ari842)

**Video 3 (20 min)** — Backpropagation, intuitively:
[Backpropagation, intuitively](https://youtu.be/Ilg3gGewQ5U?si=ANRSwDucsfT5BFbN)
...
[Training Neural Networks: Cost · Gradient Descent · Backpropagation]({{site.baseurl}}/assets/training_viz.html){:target="_blank"}
...
- [TensorFlow Playground](https://playground.tensorflow.org/#activation=tanh&batchSize=10&dataset=circle&regDataset=reg-plane&learningRate=0.03&regularizationRate=0&noise=0&networkShape=4,2&seed=0.23990&showTestData=false&discretize=false&percTrainData=50&x=true&y=true&xTimesY=false&xSquared=false&ySquared=false&cosX=false&sinX=false&cosY=false&sinY=false&collectStats=false&problem=classification&initZero=false&hideText=false)
